    ...
    createAsync = async (entity) => {
        try {
            const result = await pool.query(
                `INSERT INTO garages (id_sede, nombre, piso, ubicacion, estado, capacidad, capacidad_para_no_reservas, capacidad_reservas)
                 VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
                [entity.id_sede, entity.nombre, entity.piso, entity.ubicacion, entity.estado,
                 entity.capacidad, entity.capacidad_para_no_reservas, entity.capacidad_reservas]
            );
        ...
        try {
            const result = await pool.query(
                `UPDATE garages SET id_sede=$1, nombre=$2, piso=$3, ubicacion=$4, estado=$5,
                 capacidad=$6, capacidad_para_no_reservas=$7, capacidad_reservas=$8 WHERE id=$9 RETURNING *`,
                [entity.id_sede, entity.nombre, entity.piso, entity.ubicacion, entity.estado,
                 entity.capacidad, entity.capacidad_para_no_reservas, entity.capacidad_reservas, id]
            );
            return result.rows[0] ?? null;
        } catch (error) { console.error(error); return null; }
    }
